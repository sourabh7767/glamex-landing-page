...
<head>
    ...
    <style>
      ...
      .downArrow svg{
        width: 1rem;
        height: 1rem;
        border: 1px solid #624d47 !important;
        border-radius: 50%;
      }
...
<body data-sidebar="dark" dir="{{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}">
          ...
          <div class="container">
            ...
            <nav class="navbar navbar-expand-lg">
              <a class="navbar-brand" href="#">
                <img src="{{asset("asset1/images/logo-dark.png")}}" alt="image" >
              </a>
                ...
                <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item">
                    <div class="language-switcher">
                      <button class="btn btn-outline-secondary d-flex align-items-center" id="dropdownBtn">
                          <img id="flagIcon" src="{{asset("asset1/images/flag.svg")}}" alt="Flag" width="25">
                          <span id="selectedLang" class="mx-2">{{ app()->getLocale() == 'ar' ? 'Arabic' : 'English' }}</span>
                          <span class="downArrow">
                            <svg class="w-4 h-4 mx-2 border border-mocha rounded-full" viewBox="0 0 20 20" fill="#624D47"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>  
                          </span> <!-- Downward Arrow -->
                      </button>
              
                      <ul class="dropdown_menu" id="dropdownMenu">
                          <li><a href="{{ route('set.locel',['locel'=>'ar']) }}" class="dropdown_item" >
                              <img src="{{asset("asset1/images/flag.svg")}}" alt="Arabic Flag"><span>Arabic</span>
                              @if (app()->getLocale() == 'ar')
                              <i class="fa-solid fa-circle-check check"></i>
                              {{-- <img src="{{asset("asset1/images/selected_badge.svg")}}" alt="selected" fill="#F93822" class="badge-image"> --}}
                              @endif
                          </a></li>
                          <li><a href="{{ route('set.locel',['locel'=>'en']) }}" class="dropdown_item">
                              <img src="{{asset("asset1/images/flag.svg")}}" alt="English Flag"> <span>English</span>
                              @if (app()->getLocale() == 'en')
                              <i class="fa-solid fa-circle-check check"></i>
                                {{-- <img src="{{asset("asset1/images/selected_badge.svg")}}" alt="selected" class="badge-image"> --}}
                              @endif
                          </a></li>
                      </ul>
                  </div>
    ...
    <!-- 
                ...
                <a class="nav-link dark_btn" href="#getstarted" title="{{__("words.Download Provider App Now")}}">{{__("words.Download Provider App Now")}}</a>
              </div>
          ...
          <div class="container-fluid">
            <div class="section_title" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="300">
              ...
              <div class="screen_slider" >
                <div id="screen_slider" class="owl-carousel owl-theme" dir="ltr">
                  <div class="item">
